    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <h1 className="mt-1 text-2xl font-bold text-slate-900">Organization controls</h1>
          <p className="mt-1 max-w-2xl text-slate-500">
            Org-wide circuit breakers and hard ceilings. Per-agent auto-approve and daily caps are
            managed under{" "}
            <Link to="/policies" className="link-primary">
              Policies
            </Link>
            .
          </p>
      ...
      <section className="space-y-3">
        <div>
          <h2 className="text-sm font-semibold text-slate-800">Incident response</h2>
          <p className="text-xs text-slate-500">Immediate stop for all agent payment activity.</p>
        </div>
        <div
      ...
      <section className="space-y-3">
        <div>
          <h2 className="text-sm font-semibold text-slate-800">Exposure limits</h2>
          <p className="text-xs text-slate-500">
            Hard org max per transaction. Soft agent limits live on Policies.
          </p>
        </div>
        <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
          <h3 className="text-lg font-semibold text-slate-900">Exposure ceiling</h3>
          <p className="mt-1 text-sm text-slate-600">
            Payments above this amount are auto-rejected (not sent for approval). Agent auto-approve
            limits are capped to this value. Leave blank for no ceiling.
          </p>
